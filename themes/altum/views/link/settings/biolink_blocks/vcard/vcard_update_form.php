...
<form name="update_biolink_" method="post" role="form">
    ...
    <?php foreach(['first_name', 'last_name', 'phone', 'street', 'city', 'zip', 'region', 'country', 'email', 'website', 'company', 'note'] as $key): ?>
    <div class="form-group">
        <label><?= language()->create_biolink_vcard_modal->input->{$key} ?></label>
