                    ...
                    <div class="card-body">
                        ...
                        <form name="update_biolink" action="" method="post" role="form" enctype="multipart/form-data">
                            ...
                            if(empty($data->link->settings->image)) {
                                $data->link->settings->image_url = ASSETS_FULL_URL . 'images/avatar_default.png';
                            } else {
                                $data->link->settings->image_url = UPLOADS_FULL_URL . 'avatars/' . $data->link->settings->image;
                            }
                            ...
                            <div class="form-group">
                                <div class="m-1 d-flex flex-column align-items-center justify-content-center">
                                    <label aria-label="<?= language()->link->settings->image ?>" class="clickable">
                                        <img id="image_file_preview" src="<?= $data->link->settings->image_url ?>" data-default-src="<?= $data->link->settings->image_url ?>" data-empty-src="<?= ASSETS_FULL_URL . 'images/avatar_default.png' ?>" class="img-fluid link-image-preview" />
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="col-1 mr-2 p-0 d-none d-lg-block">
                                        <span class="fa-stack fa-1x" data-toggle="tooltip" title="<?= language()->link->biolink->{$row->type}->name ?>">
                                            <i class="fa fa-circle fa-2x" style="color: <?= language()->link->biolink->{$row->type}->color ?>"></i>
                                            <i class="fas <?= language()->link->biolink->{$row->type}->icon ?> fa-stack-1x fa-inverse" style="margin-right: 15px;"></i>
                                        </span>
                                    </div>
