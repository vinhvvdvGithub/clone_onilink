                    ...
                    <div class="d-flex align-items-center">
                        <div class="mr-3 d-flex align-items-center">
                            <span class="fa-stack fa-1x" data-toggle="tooltip" title="<?= language()->link->{$row->type}->name ?>">
                                <div>
                                    <i class="fa fa-circle fa-2x" style="color: <?= language()->link->{$row->type}->color ?>"></i>

                                    <i class="fas <?= language()->link->{$row->type}->icon ?> fa-stack-1x fa-inverse" style="margin-right: 15px;"></i>
