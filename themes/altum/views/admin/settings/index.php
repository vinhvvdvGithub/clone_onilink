                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade" id="affiliate">
                            <div <?= !\Altum\Plugin::is_active('affiliate') ? 'data-toggle="tooltip" title="' . sprintf(language()->admin_plugins->no_access, \Altum\Plugin::get('affiliate')->name ?? 'affiliate') . '"' : null ?>>
                                <div class="<?= !\Altum\Plugin::is_active('affiliate') ? 'container-disabled' : null ?>">
                                    <?php if(!in_array(settings()->license->type, ['Extended License', 'extended'])): ?>
                                        <div class="alert alert-primary" role="alert">
                                            You need to own the Extended License in order to use the affiliate system.
                                        </div>
                                    <?php endif ?>
                        ...
                        <div class="tab-pane fade" id="email_notifications">
                            ...
                            <div <?= \Altum\Plugin::is_active('affiliate') ? null : 'data-toggle="tooltip" title="' . sprintf(language()->admin_plugins->no_access, \Altum\Plugin::get('affiliate')->name ?? 'affiliate') . '"' ?>>
                                <div class="custom-control custom-switch my-3 <?= \Altum\Plugin::is_active('affiliate') ? null : 'container-disabled' ?>">
                                    <input id="email_notifications_new_affiliate_withdrawal" name="email_notifications_new_affiliate_withdrawal" type="checkbox" class="custom-control-input" <?= settings()->email_notifications->new_affiliate_withdrawal ? 'checked' : null?> <?= \Altum\Plugin::is_active('affiliate') ? null : 'disabled="disabled"' ?>>
                                    <label class="custom-control-label" for="email_notifications_new_affiliate_withdrawal"><?= language()->admin_settings->email_notifications->new_affiliate_withdrawal ?></label>
                                ...
                                <div class="<?= !\Altum\Plugin::is_active('offload') ? 'container-disabled' : null ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="offload_provider" name="offload_provider" class="form-control form-control-lg">
                                            ...
                                            <option value="wasabi" <?= settings()->offload->provider == 'wasabi' ? 'selected="selected"' : null ?>>Wasabi</option>
                                            <option value="other-s3" <?= settings()->offload->provider == 'other-s3' ? 'selected="selected"' : null ?>>Other storage compatible with S3 SDK</option>
                                        </select>
                                    </div>
